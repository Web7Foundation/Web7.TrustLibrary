...
The sample code for DIDComm Agent can be found here: https://github.com/Web7Foundation/Web7.TrustLibrary/blob/main/src/Web7.TrustedPersonalAgent1/Program.cs
